...
function App() {
  ...
  return (
    <>
      <div className='flex '>
        <div className='p-2 bg-blue-950 text-white h-screen '>
          <div className='flex flex-col justify-center items-start ml-5 rounded-lg '>

            <div className='flex justify-around mt-1 gap-10 '>
              <div>
        ...
        <div className='flex h-screen  flex-col justify-between  border-2 w-full  '>
          ...
          <div className="flex  border-2 p-2 justify-between  bg-white  ">
            ...
            <div className='flex items-center border-2 w-fit bg-gray-100 pl-5'>
              ...
              <input type="text" placeholder='Search features,tutorials , etc.' className='w-80 h-10  px-4 text-sm border-none outline-none bg-gray-100' />
          ...
          <div className="overflow-auto  flex-1">
            <div>
              ...
              <div className='flex justify-between  ml-4 mt-10 gap-4'>

                <div className='bg-sky-700 w-96  rounded-xl text-white  pt-5'>
                ...
                <div className='border-2  w-96  rounded-xl text-white  pt-5'>
            ...
            <div className='flex justify-between'>
              ...
              <div className='flex items-center border-2 w-fit bg-gray-50 pl-2 mt-5 ml-4'>
                ...
                <input type="text" placeholder='Order ID or transactions ID' className='w-80 h-10  px-2 text-sm border-none outline-none bg-gray-50' />
